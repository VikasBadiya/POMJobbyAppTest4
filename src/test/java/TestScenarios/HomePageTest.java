...
public class HomePageTest {
    ...
    public void HomePageHeadingText(){
        ...
        Assert.assertEquals(HPage.GetTextOfHeading(),"Find The Job That Fits Your Life","Heading text does not match");
        ...
        Assert.assertEquals(HPage.GetTextDescription(),"Millions of people are searching for jobs, salary information, company reviews. Find the job that fits your abilities and potential.","Description text does not match");
